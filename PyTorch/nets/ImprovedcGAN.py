"""
 > Network architecture of improved cGAN model
...
class GeneratorImprovedcGAN(nn.Module):
    """ A 5-layer UNet-based generator
    """
    def __init__(self, in_channels=3, out_channels=3):
        super(GeneratorImprovedcGAN, self).__init__()
        # encoding layers
...
class DiscriminatorImprovedcGAN(nn.Module):
    """ A 4-layer Markovian discriminator
    """
    def __init__(self, in_channels=3):
        super(DiscriminatorImprovedcGAN, self).__init__()
